...
select 'drugera' as "domain", drug_concept_id concept_id, concept_name, drug_era_start_date start_date, drug_era_end_date end_date , '' as display_value, '' as source_concept_value, '' as source_concept_name
...
select 'condition' as "domain", condition_concept_id concept_id, c.concept_name, condition_start_date start_date, condition_end_date end_date, 
...
select 'conditionera' as "domain", condition_concept_id concept_id, concept_name, condition_era_start_date start_date, condition_era_end_date end_date , '' as display_value, '' as source_concept_value, '' as source_concept_name
...
select 'observation' as "domain", observation_concept_id concept_id, c.concept_name, observation_date start_date, observation_date end_date , 
'' as display_value, s.concept_code as source_concept_value, s.concept_name as source_concept_name
...
select 'visit' as "domain", visit_concept_id concept_id, concept_name, visit_start_date start_date, visit_end_date end_date , '' as display_value, '' as source_concept_value, '' as source_concept_name
...
select 'death' as "domain", death_type_concept_id concept_id, concept_name, death_date start_date, death_date end_date, '' as display_value, '' as source_concept_value, '' as source_concept_name
...
select 'measurement' as "domain", measurement_concept_id concept_id, c.concept_name, measurement_date start_date,
...
select 'device' as "domain", device_concept_id concept_id, concept_name, device_exposure_start_date start_date, device_exposure_end_date end_date , '' as display_value, '' as source_concept_value, '' as source_concept_name
...
select 'procedure' as "domain", procedure_concept_id concept_id, c.concept_name, procedure_date start_date, procedure_date end_date , 
'' as display_value, s.concept_code as source_concept_value, s.concept_name as source_concept_name
...
select 'specimen' as "domain", specimen_concept_id concept_id, concept_name, specimen_date start_date, specimen_date end_date , '' as display_value, '' as source_concept_value, '' as source_concept_name
