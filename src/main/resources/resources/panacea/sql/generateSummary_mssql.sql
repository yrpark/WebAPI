...
(
   select 
    ...
    ,smry.lvl                                as Lvl
  FROM 
    (WITH t1( pnc_stdy_smry_id, tx_path_parent_key, lvl, tx_stg_cmb, tx_stg_cmb_pth, tx_seq, tx_stg_avg_dr, tx_stg_cnt, tx_stg_percentage, depthOrder) AS (
        SELECT 
...
(
  SELECT 
    ...
    ,smry.lvl                                as Lvl
  FROM 
    (WITH t1( pnc_stdy_smry_id, tx_path_parent_key, lvl, tx_stg_cmb, tx_stg_cmb_pth, tx_seq, tx_stg_avg_dr, tx_stg_cnt, tx_stg_percentage, tx_stg_avg_gap, depthOrder) AS (
        SELECT 
           pnc_stdy_smry_id, tx_path_parent_key,
           1 AS lvl,
