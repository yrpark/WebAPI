...
public class VocabularyService extends AbstractDaoService {
     ...
     *
     * @param search a ConceptSearch object in json format
     * @return a list of Concept objects matching the ConceptSearch criteria
     */
    @Path("search")
    @POST
    @Produces(MediaType.APPLICATION_JSON)
     ...
     *
     * @param query the text string used to search the vocabulary
     * @return a list of concepts matching the query string
     */
    @Path("search/{query}")
    @GET
    @Produces(MediaType.APPLICATION_JSON)
